...
1.  singularity pull suite.sif docker://giottopackage/suite:v4.2.0 or singularity pull suite.sif docker://giottopackage/suite:latest. Alternatively, you can also build a sandbox folder: singularity build --sandbox suite/ docker://giottopackage/suite:v4.2.0 or singularity build --sandbox suite/ docker://giottopackage/suite:latest
