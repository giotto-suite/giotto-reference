...
- Run [removeGiottoEnvironment](https://giotto-suite.github.io/GiottoClass/reference/giotto_python.html), then terminate R.
- Open a completely new R session, and run [installGiottoEnvironment](https://giotto-suite.github.io/GiottoClass/reference/giotto_python.html)
- Post to an issue to the Giotto GitHub page [here](https://github.com/giotto-suite/Giotto).
