...
Unfortunately, it is known that installing miniconda on Windows 11 can sometimes result in an [OpenSSL error](https://github.com/giotto-suite/Giotto/issues/425#issuecomment-1320499840).
...
If the issue persists, please post an issue on the [GitHub](https://github.com/giotto-suite/Giotto/issues).
</details>
</details>
</details>
