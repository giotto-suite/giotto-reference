...
1.  docker pull `giottopackage/suite:v4.2.0` or docker pull `giottopackage/suite:latest`
2.  docker run `-ti giottopackage/suite:v4.2.0 /bin/bash` or docker run `-ti giottopackage/suite:latest /bin/bash`
3.  R
