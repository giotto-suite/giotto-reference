...
1.  docker pull `giottopackage/suite:v4.2.3` or docker pull `giottopackage/suite:latest`
2.  docker run `-ti giottopackage/suite:v4.2.3 /bin/bash` or docker run `-ti giottopackage/suite:latest /bin/bash`
3.  R
