...
- `spatial_dimensions`: select spatial dimensions to use, default is all
possible dimensions
...
- `betas`: betas to test for. three numbers: start_beta, beta_increment,
...
Creates a directory with results that can be viewed with
viewHMRFresults
