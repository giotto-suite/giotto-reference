...
*Package:* `Giotto`  
*Title:* Params documentation template: plot_params
...
- `group_by`: character. Create multiple plots based on cell annotation
column
...
- `other_cell_alpha`: (0 to 1) alpha for not selected cells
