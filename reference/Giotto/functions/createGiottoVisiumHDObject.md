# `createGiottoVisiumHDObject` {#createGiottoVisiumHDObject}
...
Given the path to a VisiumHD output folder, creates a
...
- `visiumhd_dir`: filepath to the exported visiumHD directory
...
- `force_untar`: logical. Whether to force a untarring operation. Useful
