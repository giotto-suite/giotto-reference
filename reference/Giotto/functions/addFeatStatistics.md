# `addFeatStatistics` {#addFeatStatistics}
...
- **nr_cells:** Denotes in how many cells the feature is
  detected
- **per_cells:** Denotes in what percentage of cells the feature
  is detected
- **total_expr:** Shows the total sum of feature expression in
  all cells
