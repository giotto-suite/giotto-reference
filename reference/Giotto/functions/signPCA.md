...
Two different methods can be used to assess the number of relevant
or significant prinicipal components (PC's).   
 ...
 2. The Jackstraw method uses the `[permutationPA](jackstraw)`
