...
- **nr_feats:** Denotes in how many features are detected per
  cell
- **perc_feats:** Denotes what percentage of features is
  detected per cell
- **total_expr:** Shows the total sum of feature expression per
  cell
