# `create_crossSection_object` {#create_crossSection_object}
...
(default = 0.2)
- `plane_equation`: a numerical vector of length 4, in the form of
...
- `cell_subset_spatial_locations`: locations of cells selected by the
cross section
- `cell_subset_projection_locations`: 3D projection coordinates of
selected cells onto the cross section plane
- `cell_subset_projection_PCA`: pca of projection coordinates
- `cell_subset_projection_coords`: 2D PCA coordinates of selected cells
