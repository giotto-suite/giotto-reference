...
- `nrand`: An integer specifying the number of random resamplings of the
mark distribution as to create the null-distribution.
- `ncores`: An integer specifying the number of cores to be used by
BiocParallel
- `...`: Additional parameters to the
`[trendsceek_test](trendsceek)` function
...
This function is a wrapper for the trendsceek_test method
implemented in the trendsceek package
Publication: tools:::Rd_expr_doi("10.1038/nmeth.4634")
