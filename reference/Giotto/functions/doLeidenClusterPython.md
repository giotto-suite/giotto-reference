# `doLeidenClusterPython` {#doLeidenClusterPython}
...
- `partition_type`: The type of partition to use for optimization.
...
- `n_iterations`: number of interactions to run the Leiden algorithm.
