...
<https://github.com/dtsoucas/DWLS> for the *DWLS* bulk
deconvolution method, and tools:::Rd_expr_doi("10.1186/s13059-021-02362-7") for
*spatialDWLS*, the spatial implementation used here.
