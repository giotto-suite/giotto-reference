# `registerGiottoObjectList` {#registerGiottoObjectList}
...
- `method`: Method used to align gobjects. Current options are either
...
- `image_reg_name`: Arbitrary image slot name for registered images to
...
- `spatloc_unreg`: Unregistered spatial locations to align. Defaults to
'raw' slot (optional)
- `spatloc_reg_name`: Arbitrary name for registered spatial locations.
