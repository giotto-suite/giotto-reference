# `addCellIntMetadata` {#addCellIntMetadata}
...
Creates an additional metadata column with information about
...
This function will create an additional metadata column which
