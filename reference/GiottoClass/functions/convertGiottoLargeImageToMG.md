...
convert a giottoLargeImage by downsampling into a normal
...
- `mg_name`: name to assign converted magick image based giottoImage.
Defaults to name of giottoLargeImage
- `spat_unit`: spatial unit
- `spat_loc_name`: gobject spatial location name to map giottoImage
to (optional)
