...
Function to plot hexbins for features for multiple
...
- `binwidth`: numeric vector for x and y width of bins
(default is minor axis range/10, where the 10 is from `min_axis_bins`)
- `min_axis_bins`: number of bins to create per range defined by minor axis
(default value is 10)
