# `spatFeatPlot2D_single` {#spatFeatPlot2D_single}
...
- `plot_method`: character. How to plot the points. Either "ggplot" for
...
- `scale_alpha_with_expression`: scale expression with
